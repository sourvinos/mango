...
namespace Mango.Services.AuthAPI {
    ...
    public class AuthService : IAuthService {
        ...
        async Task<LoginResponseDto> IAuthService.Login(LoginRequestDto loginRequestDto) {
            var user = _db.ApplicationUsers.FirstOrDefault(x => x.UserName.Equals(loginRequestDto.UserName, StringComparison.CurrentCultureIgnoreCase));
        ...
        public async Task<bool> AssignRole(string email, string roleName) {
            var user = _db.ApplicationUsers.FirstOrDefault(x => x.Email.Equals(email, StringComparison.CurrentCultureIgnoreCase));
            if (user != null) {
